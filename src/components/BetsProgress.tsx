    ...
    <View style={styles.container}>
      <View style={styles.viewRowStyle}>
        <View style={styles.viewColumnStyle}>
          ...
          >
            <Text style={[styles.gradientText, { color: colors.greenLight }]}>
              {betsWon}
            </Text>
            {betWonPercent !== 0 && (
              <>
        ...
        <View style={styles.viewColumnStyle}>
          ...
          <TouchableOpacity
            ...
            style={styles.viewContainStyle}
          >
            <Text style={[styles.gradientText, { color: colors.darkRed }]}>
              {betsLost}
            </Text>
            {betLossPercent !== 0 && (
              <>
        ...
        <View style={styles.viewColumnStyle}>
          ...
          >
            {isGradiantColorVisible ? (
              <Text style={[styles.gradientText, { color: colors.purple }]}>
                {betsPending + "%"}
              </Text>
            ) : (
